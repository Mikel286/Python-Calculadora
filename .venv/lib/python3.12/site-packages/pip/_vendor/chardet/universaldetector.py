...
class UniversalDetector:
    ...
    def reset(self) -> None:
        ...
        """
        self._result = {"encoding": None, "confidence": 0.0, "language": None}
        self.done = False
        self._got_data = False
        self._has_win_bytes = False
        self._input_state = InputState.PURE_ASCII
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        ...
        if not self._got_data:
            ...
            if byte_str.startswith(codecs.BOM_UTF8):
                ...
                self._result = {"encoding": "UTF-32", "confidence": 1.0, "language": ""}
                ...
                self._result = {"encoding": "UTF-16", "confidence": 1.0, "language": ""}

            self._got_data = True
            if self._result["encoding"] is not None:
                self.done = True
                return
    ...
    def close(self) -> ResultDict:
        ...
        # Default to ASCII if it is all we've seen so far
            ...
            self._result = {"encoding": "ascii", "confidence": 1.0, "language": ""}
        ...
        if self.logger.getEffectiveLevel() <= logging.DEBUG:
            if self._result["encoding"] is None:
